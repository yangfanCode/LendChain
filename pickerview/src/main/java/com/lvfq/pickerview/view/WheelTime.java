...
import com.lvfq.pickerview.lib.BlankView;
...
public class WheelTime {
    ...
    private BlankView bv_left,bv_right;
    ...
    public void setPicker(int year, int month, int day, int h, int m) {
        ...
        bv_left = (BlankView) view.findViewById(R.id.bv_left);
        bv_right = (BlankView) view.findViewById(R.id.bv_right);
    ...
    public void setTextSize(float textSize) {
        ...
        bv_left.setTextSize(textSize);
        bv_right.setTextSize(textSize);
    }
    ...
    public void setLineSpacingMultiplier(float lineSpacingMultiplier) {
        ...
        bv_left.setLineSpacingMultiplier(lineSpacingMultiplier);
        bv_right.setLineSpacingMultiplier(lineSpacingMultiplier);
    }
    ...
    public BlankView getBv_left() {
        return bv_left;
    }

    public BlankView getBv_right() {
        return bv_right;
    }
}
