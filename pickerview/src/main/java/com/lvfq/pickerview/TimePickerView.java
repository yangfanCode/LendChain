...
//    }
    ...
    public BlankView getBv_left() {
        return wheelTime.getBv_left();
    }

    public BlankView getBv_right() {
        return wheelTime.getBv_right();
    }

    public void setBlankViewWeight(BlankView blankView, float weight) {
        blankView.setLayoutParams(new LinearLayout.LayoutParams(0, LinearLayout.LayoutParams.WRAP_CONTENT, weight));
    }
}
