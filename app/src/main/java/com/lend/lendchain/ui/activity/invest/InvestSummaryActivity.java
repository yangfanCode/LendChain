...
//        StatusBarUtil.setStatusBarColor(InvestSummaryActivity.this,R.drawable.bg_4885ff_gradient_509fff);//状态栏颜色
    ...
    public void initView() {
        ...
        customTabLayout.setViewHeight(DisplayUtil.dp2px(InvestSummaryActivity.this, 65));
        customTabLayout.setBottomLineWidth(DisplayUtil.dp2px(InvestSummaryActivity.this, 60));
        customTabLayout.setBottomLineHeight(DisplayUtil.dp2px(InvestSummaryActivity.this, 2));
        customTabLayout.setBottomLineHeightBgResId(R.color.color_509FFF);
        customTabLayout.setmTextColorSelect(ColorUtils.COLOR_509FFF);
        customTabLayout.setmTextColorUnSelect(ColorUtils.COLOR_999999);
        customTabLayout.setTextSize(12);
        int width = getResources().getDisplayMetrics().widthPixels;
        customTabLayout.setNeedEqual(true, width);
        initData();
        initListener();
    }
