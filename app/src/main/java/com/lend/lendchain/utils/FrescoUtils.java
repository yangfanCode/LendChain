...
public class FrescoUtils {
    ...
    public static void showThumb(SimpleDraweeView draweeView, String url, float resizeWidthDp, float resizeHeightDp) {
        ...
        ImageRequest request = ImageRequestBuilder.newBuilderWithSource(Uri.parse(url))
                .setResizeOptions(new ResizeOptions(DisplayUtil.dp2px(ContextHelper.getApplication(),resizeWidthDp), DisplayUtil.dp2px(ContextHelper.getApplication(), resizeHeightDp)))
                .build();
