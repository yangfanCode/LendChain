 ...
 * 首页行情分时图
 */
public class HomeMarketFenshiView extends ChartView {
    ...
    public HomeMarketFenshiView(Context context) {
        this(context, null);
    }

    public HomeMarketFenshiView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
...
//    }
    ...
    @Override
    protected void init() {
        mainH = mHeight *  MAIN_SCALE;//首页没时间 高度定制
        Log.e("dingzuo", "----init()-------");
